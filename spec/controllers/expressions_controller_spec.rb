  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved expression as @expression" do
        ...
        post :create, {:expression => { "token" => "invalid value" }}, valid_session
        assigns(:expression).should be_a_new(Expression)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested expression" do
        ...
        Expression.any_instance.should_receive(:update).with({ "token" => "MyString" })
        put :update, {:id => expression.to_param, :expression => { "token" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the expression as @expression" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Expression.any_instance.stub(:save).and_return(false)
        put :update, {:id => expression.to_param, :expression => { "token" => "invalid value" }}, valid_session
        assigns(:expression).should eq(expression)
      end
